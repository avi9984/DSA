// N students have taken the examination in the Berland institute of Technology. The score of the ith student in the examination is Ai and the maximum possible score in the examination is M.

// You are student K and have hacked into thes institute database which stores the scores of all the students.

// You want to increase your score as much as possible. But if the median of the scores of all the students changes by increasing your score, the examination board will get alerted and will fail you in the examination.

// Given array A denoting the scores of all the students, print the maximum possible score you can get such that the examination board does not get alerted.

// Note :

// Median of an array of length N is the (N+1)/2th element of the array in sorted order. Like the median of [4,1,3,2] = 2, [4,1,3,2,5] = 3 and so on.
// Input Format
...
console.log(increaseScore([1, 2, 3, 4, 5]));
